		...
		<div class="container">
			...
			<div class="row inner-menu-box">
                    <div class="card-group">
                        <div class="card">
                          <img src="images/lomo.jpg" class="card-img-top" alt="20" height="240">
                          <div class="card-body">
                        ...
                        <div class="card">
                          <img src="images/arrozconpollo-peruano.png" class="card-img-top" alt="20" height="240">
                          <div class="card-body">
                            <h5 class="card-title">Arroz con Pollo Peruano</h5>
